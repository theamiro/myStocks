...
;(function (root, factory) {
	...
	var DateRangePicker = function (element, options, cb) {
		...
		if (typeof options.template !== "string" && !(options.template instanceof $))
			options.template =
				'<div class="card daterangepicker py-4 px-3">' +
				'<div class="card-header d-flex flex-column border-0 bg-light py-0">' +
				'<div class="d-flex justify-content-end">' +
				'<button class="cancelBtn btn-close" type="button"></button>' +
				"</div>" +
				'<div class="row">' +
				'<div class="col">' +
				'<p class="">From</p>' +
				...
				'<div class="col">' +
				'<p class="">To</p>' +
				'<p class="end-date-marker"></p>' +
				"</div>" +
				"</div>" +
				"</div>" +
				'<div class="card-body py-0">' +
				'<div class="drp-calendar left">' +
				'<div class="calendar-table border px-2 pt-1 pb-2 border-radius"></div>' +
				'<div class="calendar-time"></div>' +
				"</div>" +
				"</div>" +
				'<div class="card-footer bg-light border-0 d-grid">' +
				'<button class="applyBtn btn btn-primary mt-3" disabled="disabled" type="button"></button> ' +
				"</div>" +
				"</div>" +
				"</div>"
		...
		this.container.find(".card-footer").on("click.daterangepicker", "button.applyBtn", $.proxy(this.clickApply, this))
		this.container.find(".card-header").on("click.daterangepicker", "button.cancelBtn", $.proxy(this.clickCancel, this))
	...
	DateRangePicker.prototype = {
		...
		setEndDate: function (endDate) {
			...
			this.container.find(".start-date-marker").html(this.startDate.format(this.locale.format))
			this.container.find(".end-date-marker").html(this.endDate.format(this.locale.format))
		...
		updateView: function () {
			...
			if (this.endDate) this.container.find(".start-date-marker").html(this.startDate.format(this.locale.format))
			if (this.endDate) this.container.find(".end-date-marker").html(this.endDate.format(this.locale.format))
			this.updateMonthsInView()
		...
		renderCalendar: function (side) {
			...
			var html = '<table class="table-flush">'
			html += "<thead>"
			html += "<tr>"
			...
			html += '<th colspan="5" class="month text-start">' + dateHtml + "</th>"
